...
public class CashRegisterImpl implements CashRegister {
    ...
    private void displayTakenBills() {
            ...
            try{
                ...
                if( changeValue < 1 ){
                    ...
                    if(tempChange > 0) { // If greedy algo does not work, back track first using dynamic programming
                        ...
                        if (coinsUsed[denomLen-1][changeValue] == 0){ //if greedy and dp doesn't work, no change can be made
                            ...
                            System.out.println("sorry");
                        } else { //get results from dynamic programming and put in takenBills array to be displayed
                            takenBills = new int[]{0, 0, 0, 0, 0};
                    ...
                    } else { //display taken bills when greedy algo is successful
                        displayTakenBills();
                    }
                }
